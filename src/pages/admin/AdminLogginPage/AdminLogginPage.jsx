...
import './AdminLogginPage.css'
import { useState } from 'react'
import axios from 'axios'
import { useNavigate } from 'react-router-dom'

const AdminLogginPage = () => {
            ...
            <div className="adminlogginpage">
                ...
                <form className="form_container" onSubmit={handleSubmit}>
                    <div className="title_container">
                        <p className="title">Login your Admin Pannel</p>
                    </div>
                    <br />
                    <div className="input_container">
                        ...
                        <input placeholder="Enter username" type="text" className="input_field" id="email_field" onChange={(e) => setEmail(e.target.value)} value={username} />
                    </div>
                    <div className="input_container">
                        <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" className="icon">
                        ...
                        <input placeholder="Password" title="Inpit title" name="input-name" type="password" className="input_field" id="password_field" onChange={(e)=>setPassword(e.target.value)} value={password} />
                    </div>
...
export default AdminLogginPage
